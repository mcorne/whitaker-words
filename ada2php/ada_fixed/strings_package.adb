...
*//
    ...
    /// function TRIM(SOURCE : in STRING; SIDE : in TRIM_END := BOTH) return STRING is
    function TRIM($SOURCE /* STRING */, $SIDE /* TRIM_END */ = 'BOTH') return STRING is
    begin
...
*//
    ...
    /// function HEAD(SOURCE : in STRING; COUNT  : in NATURAL; PAD     : in CHARACTER := ' ') return STRING is
...
*//
    ...
    procedure GET_NON_COMMENT_LINE(F : in TEXT_IO.FILE_TYPE; S : out STRING; LAST : out INTEGER) is
    begin
